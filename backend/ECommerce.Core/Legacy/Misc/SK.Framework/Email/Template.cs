...
public class Attachment
{
    ...
    public string MediaType { get; set; } = string.Empty; // text, image, application, audio, video,

    public string MediaSubType { get; set; } = string.Empty; // plain, html, jpeg, png, pdf, zip, etc.
}
