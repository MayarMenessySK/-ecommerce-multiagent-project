...
public static class PagingHelpers
{
    ...
    /// <summary>
    /// This is applicable for Bootstrap version 4.0
    /// </summary>
    ...
    {
        bool isRtl = CultureInfo.CurrentCulture.Name == "ar-EG" || CultureInfo.CurrentCulture.Name == "ar";
        ...
        IHtmlContent DirectionMaker(string icon, string url)
        {
            ...
            iconTag.MergeAttribute("style", "margin-bottom:2px;margin-top:2px;");
        ...
        if (totalPages > 1 && currentPage != 1)
        {
            if (isRtl)
            {
                list.InnerHtml.AppendHtml(DirectionMaker("fa fa-angle-double-right", pageUrl(1)));
        ...
        if (totalPages > 1 && currentPage != totalPages)
        {
            ...
            {
                list.InnerHtml.AppendHtml(DirectionMaker("fa fa-angle-left", pageUrl(currentPage + 1)));
                list.InnerHtml.AppendHtml(DirectionMaker("fa fa-angle-double-left", pageUrl(totalPages)));
            }
            else
            {
                list.InnerHtml.AppendHtml(DirectionMaker("fa fa-angle-right", pageUrl(currentPage + 1)));
