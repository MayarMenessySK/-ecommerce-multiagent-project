...
public class V100_SeedInitialData : Migration
{
    public override void Up()
    {
        ...
        Execute.Sql(@"
            ...
            (gen_random_uuid(), 'Clothing', 'clothing', 'Men''s and women''s clothing', 'https://via.placeholder.com/300x200?text=Clothing', NULL, 0, true, 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
        ...
        Execute.Sql(@"
            ...
            BEGIN
                ...
                (gen_random_uuid(), 'Laptop Ultrabook 15"', 'laptop-ultrabook-15', 'LU-15-001', 'Powerful ultrabook with Intel i7, 16GB RAM, 512GB SSD, and stunning 4K display. Perfect for work and entertainment.', 'Ultra-thin laptop with powerful performance', 1299.99, 1599.99, 18.75, 25, 5, electronics_id, 'CompuMax', true, false, 4.6, 234, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
                (gen_random_uuid(), '4K Smart TV 55"', '4k-smart-tv-55', 'TV-55-4K-001', 'Immersive 4K Ultra HD Smart TV with HDR, built-in streaming apps, and voice control. Transform your living room.', 'Premium 4K Smart TV with HDR', 799.99, NULL, NULL, 15, 3, electronics_id, 'VisionTech', true, true, 4.8, 156, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
                ...
                INSERT INTO products (id, name, slug, sku, description, short_description, price, original_price, discount_percentage, stock_quantity, low_stock_threshold, category_id, brand, is_active, is_featured, average_rating, total_reviews, created_at, updated_at)
                VALUES 
                (gen_random_uuid(), 'Men''s Cotton T-Shirt', 'mens-cotton-tshirt', 'MCT-001', 'Comfortable 100% cotton t-shirt in multiple colors. Breathable fabric perfect for everyday wear.', 'Classic cotton t-shirt for men', 19.99, 29.99, 33.33, 200, 30, clothing_id, 'StyleHub', true, false, 4.2, 89, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
                (gen_random_uuid(), 'Women''s Denim Jeans', 'womens-denim-jeans', 'WDJ-001', 'Stylish skinny fit denim jeans with stretch fabric for maximum comfort. Available in multiple sizes.', 'Comfortable skinny fit jeans', 49.99, 69.99, 28.57, 150, 25, clothing_id, 'DenimCo', true, true, 4.6, 234, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
