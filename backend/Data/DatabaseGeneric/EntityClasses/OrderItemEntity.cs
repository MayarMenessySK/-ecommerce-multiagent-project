...
namespace ECommerce.Data.EntityClasses
{
	...
	
	{
		...
		protected class OrderItemEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("OrderItemEntity", InheritanceHierarchyType.None, false, (int)ECommerce.Data.EntityType.OrderItemEntity, typeof(OrderItemEntity), typeof(OrderItemEntityFactory), false);
				AddNavigatorMetaData<OrderItemEntity, OrderEntity>("Order", "OrderItems", (a, b) => a._order = b, a => a._order, (a, b) => a.Order = b, ECommerce.Data.RelationClasses.StaticOrderItemRelations.OrderEntityUsingOrderIdStatic, ()=>new OrderItemRelations().OrderEntityUsingOrderId, null, new int[] { (int)OrderItemFieldIndex.OrderId }, null, true, (int)ECommerce.Data.EntityType.OrderEntity);
				AddNavigatorMetaData<OrderItemEntity, ProductEntity>("Product", "OrderItems", (a, b) => a._product = b, a => a._product, (a, b) => a.Product = b, ECommerce.Data.RelationClasses.StaticOrderItemRelations.ProductEntityUsingProductIdStatic, ()=>new OrderItemRelations().ProductEntityUsingProductId, null, new int[] { (int)OrderItemFieldIndex.ProductId }, null, true, (int)ECommerce.Data.EntityType.ProductEntity);
			}
		}
