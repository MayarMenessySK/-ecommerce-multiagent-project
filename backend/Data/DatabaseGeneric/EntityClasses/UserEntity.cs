...
namespace ECommerce.Data.EntityClasses
{
	...
	
	{
		...
		protected class UserEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("UserEntity", InheritanceHierarchyType.None, false, (int)ECommerce.Data.EntityType.UserEntity, typeof(UserEntity), typeof(UserEntityFactory), false);
				AddNavigatorMetaData<UserEntity, EntityCollection<AddressEntity>>("Addresses", a => a._addresses, (a, b) => a._addresses = b, a => a.Addresses, () => new UserRelations().AddressEntityUsingUserId, typeof(AddressEntity), (int)ECommerce.Data.EntityType.AddressEntity);
				AddNavigatorMetaData<UserEntity, EntityCollection<CartEntity>>("Carts", a => a._carts, (a, b) => a._carts = b, a => a.Carts, () => new UserRelations().CartEntityUsingUserId, typeof(CartEntity), (int)ECommerce.Data.EntityType.CartEntity);
				AddNavigatorMetaData<UserEntity, EntityCollection<CouponUsageEntity>>("CouponUsages", a => a._couponUsages, (a, b) => a._couponUsages = b, a => a.CouponUsages, () => new UserRelations().CouponUsageEntityUsingUserId, typeof(CouponUsageEntity), (int)ECommerce.Data.EntityType.CouponUsageEntity);
				AddNavigatorMetaData<UserEntity, EntityCollection<OrderEntity>>("Orders", a => a._orders, (a, b) => a._orders = b, a => a.Orders, () => new UserRelations().OrderEntityUsingUserId, typeof(OrderEntity), (int)ECommerce.Data.EntityType.OrderEntity);
				AddNavigatorMetaData<UserEntity, EntityCollection<PaymentEntity>>("Payments", a => a._payments, (a, b) => a._payments = b, a => a.Payments, () => new UserRelations().PaymentEntityUsingUserId, typeof(PaymentEntity), (int)ECommerce.Data.EntityType.PaymentEntity);
				AddNavigatorMetaData<UserEntity, EntityCollection<ReviewEntity>>("Reviews", a => a._reviews, (a, b) => a._reviews = b, a => a.Reviews, () => new UserRelations().ReviewEntityUsingUserId, typeof(ReviewEntity), (int)ECommerce.Data.EntityType.ReviewEntity);
				AddNavigatorMetaData<UserEntity, EntityCollection<SavedPaymentMethodEntity>>("SavedPaymentMethods", a => a._savedPaymentMethods, (a, b) => a._savedPaymentMethods = b, a => a.SavedPaymentMethods, () => new UserRelations().SavedPaymentMethodEntityUsingUserId, typeof(SavedPaymentMethodEntity), (int)ECommerce.Data.EntityType.SavedPaymentMethodEntity);
				AddNavigatorMetaData<UserEntity, EntityCollection<WishlistEntity>>("Wishlists", a => a._wishlists, (a, b) => a._wishlists = b, a => a.Wishlists, () => new UserRelations().WishlistEntityUsingUserId, typeof(WishlistEntity), (int)ECommerce.Data.EntityType.WishlistEntity);
			}
		}
